 ...
 <!-- 상단 header start -->
    ...
    <div class="main-background">
      ...
      <div class="container-fluid h-25 row">
        ...
        <form
          action="html/searchHouseDeal.html"
          method="get"
          class="row col-sm-8 justify-content-center align-content-center"
        >
          <div class="col pl-1">
            <select name="year" id="year" class="form-control bg-dark text-light">
          ...
          <div class="col pl-1">
            <select name="month" id="month" class="form-control bg-dark text-light">
    ...
    <c:if test="${ !empty message }">
		<div class="container bg-light mt-3" style="width: 100%; height: 500px">
			<h4 style="color:black;text-align:center;font-weight:bold"><br/>처리 중 문제가 발생하였습니다.</h4>
			<hr>
			<h4 style="color:black;text-align:center;font-weight:bold">문제 내용 - ${ message }</h4>
		</div>
		</c:if>
