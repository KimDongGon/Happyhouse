...
//	@GetMapping
//	public ResponseEntity<Map<Integer, NewsDto>> startCrawl() throws IOException { 		
//
//		Map<Integer, NewsDto> map = new HashMap<Integer, NewsDto>();
...
//		}
//		
//		return new ResponseEntity<Map<Integer,NewsDto>>(map, HttpStatus.OK);
//	}
	
	@GetMapping
	public ResponseEntity<List<NewsDto>> startCrawl() throws IOException { 		
